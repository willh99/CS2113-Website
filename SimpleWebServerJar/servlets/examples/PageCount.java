...
public class PageCount extends HttpServlet {
	...
	// Write out the action, since that's common to all the generated HTML.

	// CHANGE TO YOUR PORT NUMBER:
	out.println ("<form action=\"http://unix.seas.gwu.edu:40220/servlets/examples/PageCount\" method=\"post\">");

	// out.println ("<form action=\"http://localhost:40013/servlets/examples/PageCount\" method=\"post\">");
	...
	out.println ("<input type=\"hidden\" name=\"username\" value=\"" + userName + "\">");    out.println ("<input type=\"hidden\" name=\"page\" value=\"featurepage\">");
    }
