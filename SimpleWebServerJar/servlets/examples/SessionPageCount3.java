...
public class SessionPageCount3 extends HttpServlet {
    ...
    Hashtable<String,SessionInfo> sessionTable = new Hashtable<String,SessionInfo> ();
	...
	out.println ("<form action=\"http://unix.seas.gwu.edu:40219/servlets/examples/SessionPageCount3\" method=\"post\">");

	// out.println ("<form action=\"http://localhost:40013/servlets/examples/SessionPageCount3\" method=\"post\">");
